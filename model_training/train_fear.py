...
# Create binary labels for "fear" (assuming fear is class index 0)
target_emotion = "fear"
...
with open(r"D:\Projects\MoodMate\paper_code\Plots\fear\classification_report.txt", "w") as f:
...
plt.savefig(r"D:\Projects\MoodMate\paper_code\Plots\fear\confusion_matrix.pdf")
plt.close()
...
plt.legend()
plt.savefig(r"D:\Projects\MoodMate\paper_code\Plots\fear\training_vs_validation_accuracy_curve.pdf")
...
plt.legend()
plt.savefig(r"D:\Projects\MoodMate\paper_code\Plots\fear\training_vs_validation_loss_curve.pdf")
...
plt.legend()
plt.tight_layout()
plt.savefig(r"D:\Projects\MoodMate\paper_code\Plots\fear\precision_recall_curve.pdf")
plt.close()
...
plt.legend()
plt.tight_layout()
plt.savefig(r"D:\Projects\MoodMate\paper_code\Plots\fear\ROC_curve.pdf")
plt.close()

print(f"ROC AUC Score = {auc_score:.3f}")
# Save Model
# ----------------------------
model.save(r"D:\Projects\MoodMate\paper_code\models\fear_model.h5")
