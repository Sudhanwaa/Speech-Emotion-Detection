...
# Create binary labels for "happy" (assuming happy is class index 0)
...
with open(r"D:\Projects\MoodMate\paper_code\Plots\happy\classification_report.txt", "w") as f:
...
plt.savefig(r"D:\Projects\MoodMate\paper_code\Plots\happy\confusion_matrix.pdf")
plt.close()
...
plt.legend()
plt.savefig(r"D:\Projects\MoodMate\paper_code\Plots\happy\training_vs_validation_accuracy_curve.pdf")
...
plt.legend()
plt.savefig(r"D:\Projects\MoodMate\paper_code\Plots\happy\training_vs_validation_loss_curve.pdf")
...
plt.legend()
plt.tight_layout()
plt.savefig(r"D:\Projects\MoodMate\paper_code\Plots\happy\precision_recall_curve.pdf")
plt.close()
...
plt.legend()
plt.tight_layout()
plt.savefig(r"D:\Projects\MoodMate\paper_code\Plots\happy\ROC_curve.pdf")
plt.close()
...
# Save Model
# ----------------------------
model.save(r"D:\Projects\MoodMate\paper_code\models\happy_model.h5")
