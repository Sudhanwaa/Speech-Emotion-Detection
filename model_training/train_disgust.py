...
# Create binary labels for "disgust" (assuming disgust is class index 0)
...
with open(r"D:\Projects\MoodMate\paper_code\Plots\disgust\classification_report.txt", "w") as f:
...
plt.savefig(r"D:\Projects\MoodMate\paper_code\Plots\disgust\confusion_matrix.pdf")
plt.close()
...
plt.legend()
plt.savefig(r"D:\Projects\MoodMate\paper_code\Plots\disgust\training_vs_validation_accuracy_curve.pdf")
...
plt.legend()
plt.savefig(r"D:\Projects\MoodMate\paper_code\Plots\disgust\training_vs_validation_loss_curve.pdf")
...
plt.legend()
plt.tight_layout()
plt.savefig(r"D:\Projects\MoodMate\paper_code\Plots\disgust\precision_recall_curve.pdf")
plt.close()
...
plt.legend()
plt.tight_layout()
plt.savefig(r"D:\Projects\MoodMate\paper_code\Plots\disgust\ROC_curve.pdf")
plt.close()
